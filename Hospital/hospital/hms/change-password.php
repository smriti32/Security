...
if (isset($_POST['submit'])) {
    ...
    $old_password = mysqli_real_escape_string($con, $_POST['cpass']);
    $new_password = mysqli_real_escape_string($con, $_POST['npass']);
    ...
    if ($user && password_verify($old_password, $user['password'])) {
        ...
        $update_sql = mysqli_query($con, "UPDATE users SET password='$hashed_new_password', updationDate='$currentTime' WHERE id='".$_SESSION['id']."'");
    ...
    // Redirect or reload the page to display the message
